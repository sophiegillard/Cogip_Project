    ...
    <main class="dashboard">
      <section class="dashboard__menu">
        ...
        <nav class="dashboard__menu__nav">
          <a class="dashboard__menu__nav__dashboard" href=""><img src="assets/img/icons/dashboard/Icon_dashboard.png" alt="">Dashboard</a>
          <a class="dashboard__menu__nav__invoices" href=""><img src="assets/img/icons/dashboard/Icon_Invoices.png" alt="">Invoices</a>
          <a class="dashboard__menu__nav__companies" href=""><img src="assets/img/icons/dashboard/Icon_Companies.png" alt="">Companies</a>
          <a class="dashboard__menu__nav__contact" href=""><img src="assets/img/icons/dashboard/Icon_contact.png" alt="">Contact</a>
        </nav>
